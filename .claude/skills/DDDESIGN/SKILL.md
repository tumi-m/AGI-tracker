---
name: DDDESIGN
description: Designing beautiful, practical websites. Use whenever designing, redesigning, critiquing, or polishing any web UI in this project — turns "make it look better" into a repeatable workflow (strategy, structure, skeleton, surface, validate) with tokens, hierarchy rules, and accessibility passes.
---
